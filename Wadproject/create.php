...
<html>
	<head>
		...
		function fun(id,x1,y1)
		{
			
		var parameters="price="+y1+"&name="+x1+"&id="+id;
		
		var x = new XMLHttpRequest();
		x.open("POST","remove.php",true);
		...
		<div id="main">
				...
				<div style="display: inline-block;">
				  ...
				  <div style="display: inline-block;" class="menu-item"><li><a href="#" class="menu-item2">Contact US</a></li></div>
					...
					<div id="second">
						<form  action="create_action.php" method="POST" class="mom">
							Enter  UserName:<br/>
							<input type="text" name="username" /> <br><br>
							Enter  Password:<br/>
							<input type="password" name="pass" /> <br><br>
							
							<input type="submit"  value="Create" class="bun"/><br>
